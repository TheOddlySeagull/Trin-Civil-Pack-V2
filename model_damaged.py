...
folder_path = args.folder_path.replace("\\", os.sep)
        ...
        if not any(anim.get("variable", None) == "damage_totaled" for anim in obj.get("animations", []) ):
            ...
            for anim in obj.get("animations", []):
                ...
                if anim.get("variable", None) != "damage_totaled":
                    ...
                    '''
                    # Create a new animation only if center_point is not None
                    if center_point is not None:
                        ...
                        print("centerPoint is None, skipping damage_totaled animation addition")
        else:
